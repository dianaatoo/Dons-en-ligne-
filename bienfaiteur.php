...
<head>
    ...
    <style>
        ...
        .option-block {
            background-color: black; /* Couleur de fond pour chaque option */
        ...
        /* Style pour les options */
        .option-block1 {
            background-color: orange; /* Couleur de fond pour chaque option */
            border: 1px solid #dee2e6; /* Bordure autour de chaque option */
            border-radius: 5px; /* Coins arrondis */
            padding: 15px; /* Rembourrage interne */
            margin: 10px; /* Marge entre les options */
        ...
        .option-block2 {
            background-color: yellow; /* Couleur de fond pour chaque option */
            border: 1px solid #dee2e6; /* Bordure autour de chaque option */
            border-radius: 5px; /* Coins arrondis */
            padding: 15px; /* Rembourrage interne */
            margin: 10px; /* Marge entre les options */
        ...
        body{
            background-image: url(dons-02.jpg);
        ...
        <div class="guylene">
            ...
            <div class="options-container">
                ...
                <div class="option-block2">
                    <div class="option-title">Faire un don</div>
                    <a class="btn btn-link" href="planificationetres.php">Accéder</a>
                </div>
